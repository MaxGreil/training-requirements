...
We assigned genes to PRDM1 peaks and performed pathway enrichment (see **Table 1**).
...
datatable(PRDM1_egodf, options=list(scrollX = TRUE, scrollY = TRUE), caption = 'Table 1', class = 'cell-border stripe')
```

We assigned genes to ZNF414 peaks and performed pathway enrichment (see **Table 2**).
...
**Table 3** shows the genes shared between PRDM1 and ZNF414.
