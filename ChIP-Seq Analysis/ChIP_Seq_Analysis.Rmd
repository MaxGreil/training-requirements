...
**Table 1** shows the genes shared in the overlap between PRDM1 and ZNF414.
...
datatable(intersect_genes, options=list(scrollX = TRUE, scrollY = TRUE), caption = 'Table 1', class = 'cell-border stripe')
```

**Table 2** shows the pathways/genesets shared in the overlap between PRDM1 and ZNF414.

```{r}
datatable(overlaps_egodf, options=list(scrollX = TRUE, scrollY = TRUE), caption = 'Table 2', class = 'cell-border stripe')
```

### 4.2) What pathways differ? 

**Table 3** shows the pathways that differ between the overlap and PRDM1.
...
datatable(outersect_ego_PRDM1, options=list(scrollX = TRUE, scrollY = TRUE), caption = 'Table 3', class = 'cell-border stripe')
```

**Table 4** shows the pathways that differ between the overlap and ZNF414.
...
datatable(outersect_ego_ZNF414, options=list(scrollX = TRUE, scrollY = TRUE), caption = 'Table 4', class = 'cell-border stripe')
```
